      ...
      case 'hipertrofia':
        return [
          _WorkoutTemplate(
            ...
            exercises: [
              _TemplateExercise(name: 'Supino Máquina', sets: 3, reps: '10-12'),
              _TemplateExercise(name: 'Puxada Frontal', sets: 3, reps: '10-12'),
              _TemplateExercise(name: 'Leg Press', sets: 3, reps: '10-12'),
              _TemplateExercise(name: 'Desenvolvimento Máquina', sets: 3, reps: '10-12'),
              ...
              _TemplateExercise(name: 'Tríceps Pulley', sets: 2, reps: '10-12'),
            ],
          ),
          _WorkoutTemplate(
            id: 'hiper_peito_triceps',
            name: 'Peito e Tríceps - Volume',
            description: 'Treino de volume para peito e tríceps',
            ...
            exercises: [
              ...
              _TemplateExercise(name: 'Tríceps Pulley', sets: 4, reps: '10-12'),
              _TemplateExercise(name: 'Tríceps Francês', sets: 3, reps: '10-12'),
              _TemplateExercise(name: 'Tríceps Testa', sets: 3, reps: '10-12'),
            ],
          ),
          _WorkoutTemplate(
            id: 'hiper_costas_biceps',
            name: 'Costas e Bíceps - Volume',
            description: 'Treino de volume para costas e bíceps',
            difficulty: 'Intermediário',
            duration: 55,
            exerciseCount: 6,
          ...
          _WorkoutTemplate(
            ...
            duration: 60,
            exerciseCount: 7,
            muscleGroups: ['Quadríceps', 'Posteriores', 'Glúteos'],
            exercises: [
          ...
          _WorkoutTemplate(
            ...
            exercises: [
              ...
              _TemplateExercise(name: 'Elevação Lateral', sets: 4, reps: '12-15'),
              _TemplateExercise(name: 'Elevação Frontal', sets: 3, reps: '12-15'),
          ...
          _WorkoutTemplate(
            ...
            exercises: [
              ...
              _TemplateExercise(name: 'Tríceps Pulley', sets: 4, reps: '10-12'),
              _TemplateExercise(name: 'Tríceps Francês', sets: 4, reps: '10-12'),
              _TemplateExercise(name: 'Tríceps Testa', sets: 3, reps: '10-12'),
      ...
      case 'forca':
        return [
          _WorkoutTemplate(
            id: 'forca_iniciante',
            name: 'Força - Base',
            description: 'Construção de base de força',
            difficulty: 'Iniciante',
            duration: 45,
            exerciseCount: 5,
            muscleGroups: ['Full Body'],
          ...
          _WorkoutTemplate(
            id: 'forca_upper',
            name: 'Força Superior',
            description: 'Força para membros superiores',
            difficulty: 'Intermediário',
            duration: 55,
            exerciseCount: 6,
          ...
          _WorkoutTemplate(
            id: 'forca_lower',
            name: 'Força Inferior',
            description: 'Força para membros inferiores',
            difficulty: 'Intermediário',
            duration: 60,
            exerciseCount: 5,
            muscleGroups: ['Quadríceps', 'Posteriores', 'Glúteos'],
        ...
        return [
          _WorkoutTemplate(
            ...
            exercises: [
              ...
              _TemplateExercise(name: 'Flexão', sets: 3, reps: '12'),
          ...
          _WorkoutTemplate(
            ...
            description: 'Treino de definição para superiores',
            difficulty: 'Intermediário',
            duration: 45,
            exerciseCount: 7,
            ...
            exercises: [
              ...
              _TemplateExercise(name: 'Tríceps Pulley', sets: 3, reps: '12-15'),
            ],
          ),
          _WorkoutTemplate(
            id: 'emag_lower',
            name: 'Inferior - Definição',
            description: 'Treino de definição para inferiores',
            difficulty: 'Intermediário',
            duration: 45,
            exerciseCount: 6,
            muscleGroups: ['Quadríceps', 'Posteriores', 'Glúteos'],
          ...
          _WorkoutTemplate(
            ...
            exercises: [
              ...
              _TemplateExercise(name: 'Abdominal Oblíquo', sets: 3, reps: '15'),
      ...
      case 'resistencia':
        return [
          _WorkoutTemplate(
            ...
            description: 'Construção de base de resistência',
            difficulty: 'Iniciante',
            duration: 40,
            exerciseCount: 6,
            muscleGroups: ['Full Body', 'Cardio'],
            exercises: [
              ...
              _TemplateExercise(name: 'Flexão', sets: 3, reps: '15'),
          ...
          _WorkoutTemplate(
            ...
            muscleGroups: ['Full Body', 'Cardio'],
            exercises: [
              _TemplateExercise(name: 'Remo Ergométrico', sets: 1, reps: '500m'),
          ...
          _WorkoutTemplate(
            ...
            exercises: [
              ...
              _TemplateExercise(name: 'Elíptico', sets: 1, reps: '10min'),
          ...
          _WorkoutTemplate(
            ...
            description: 'Circuito para resistência muscular',
            difficulty: 'Intermediário',
            duration: 40,
            exerciseCount: 8,
            muscleGroups: ['Full Body'],
            exercises: [
              ...
              _TemplateExercise(name: 'Flexão', sets: 4, reps: '15'),
      ...
      case 'funcional':
        return [
          _WorkoutTemplate(
            id: 'func_iniciante',
            name: 'Funcional - Base',
            description: 'Movimentos funcionais básicos',
            difficulty: 'Iniciante',
            duration: 35,
            exerciseCount: 6,
            muscleGroups: ['Full Body'],
            exercises: [
              ...
              _TemplateExercise(name: 'Flexão', sets: 3, reps: '10'),
              _TemplateExercise(name: 'Prancha', sets: 3, reps: '30s'),
              _TemplateExercise(name: 'Afundo', sets: 3, reps: '10'),
              _TemplateExercise(name: 'Remada TRX', sets: 3, reps: '12'),
              _TemplateExercise(name: 'Ponte de Glúteo', sets: 3, reps: '15'),
            ],
          ),
          _WorkoutTemplate(
            id: 'func_mobilidade',
            ...
            exercises: [
              ...
              _TemplateExercise(name: 'Rotação Tórax', sets: 2, reps: '10'),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Selecione uma categoria para ver os templates disponíveis',
