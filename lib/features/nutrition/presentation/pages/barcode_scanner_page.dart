...
class _BarcodeScannerPageState extends ConsumerState<BarcodeScannerPage>
        ...
        child: FadeTransition(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: kIsWeb
                    ? _buildWebUnavailableView(isDark)
                    : _isScanning
  ...
  Widget _buildWebUnavailableView(bool isDark) {
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'O scanner de código de barras não está disponível na versão web. Por favor, use o aplicativo mobile ou digite o código manualmente.',
